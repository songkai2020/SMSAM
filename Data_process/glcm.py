...
if __name__ == '__main__':
    ...
    angle = [0]
    #original image path
    path1='/content/sample_data/rec_total_16'
    #save path
    path2='/content/sample_data/glcm_entropy'
    ...
    for img_ in imgs:
      ...
      #np.savetxt(path2+'/'+img_.split('.')[0]+'.txt', entropy, fmt="%f", delimiter=" ")
      np.save(path2+'/'+img_.split('.')[0]+'.txt', entropy)
